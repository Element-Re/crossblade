...
- [New] Added new settings to allow users to customize how they want to use Crossblade, optionally favoring combat events, custom events, or a mixed approach
